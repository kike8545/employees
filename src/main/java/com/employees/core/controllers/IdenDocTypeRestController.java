...
import com.employees.core.services.IdenDocTypeInterfaceService;
...
public class IdenDocTypeRestController {
  ...
  @ResponseBody
  public List<IdentityDocumentType> list() {
    List<IdentityDocumentType> res = new ArrayList<>(IdenDocTypeService.findAll());
